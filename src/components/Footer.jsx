  ...
  return (
    <footer className="bg-navy-dark text-[#9ab0d4] px-[5%] py-10 flex justify-between items-center flex-wrap gap-4">
      <div className="flex items-center gap-3">
        <div className="w-9 h-9 bg-jds-blue rounded flex items-center justify-center font-black text-[11px] text-white">
          JDS
        </div>
      ...
      <p className="text-xs">
        &copy; {new Date().getFullYear()} JCICREED Delivery Services. All rights reserved.
      </p>
